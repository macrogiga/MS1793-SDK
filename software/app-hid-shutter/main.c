...
extern void IrqMcuGotoSleepAndWakeup(void); //only used in interrupt running mode
...
#define LEN_ADV 11 //max 31
unsigned char pld_adv[LEN_ADV] = {2, 0x1, 0x6, 3, 0x19, 0xc1, 0x03, 3, 0x3, 0x12, 0x18};
